  ...
  const stateChangeHandler = (e, videoNumber) => {
    ...
    if (e.data === 1) {
      ...
      if (isAllReady) {
        ...
        video1Ref.current && preferredVideoState === 1 && video1Ref.current.playVideo();
        video2Ref.current && preferredVideoState === 1 && video2Ref.current.playVideo();
        video3Ref.current && preferredVideoState === 1 && video3Ref.current.playVideo();
        video4Ref.current && preferredVideoState === 1 && video4Ref.current.playVideo();
      }
    }
